...
export default function PostBulkEWasteScreen({ navigation }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const result = await bulkEWasteAPI.create(data);

            Alert.alert('Success', 'Bulk e-waste posted successfully!', [
                {
                    text: 'OK',
            ...
            console.error('Post bulk e-waste error:', error);
            Alert.alert('Error', error.response?.data?.error || 'Failed to post bulk e-waste');
        } finally {
            setLoading(false);
        }
    };
            ...
            <ScrollView style={styles.scrollView}>
                <View style={styles.content}>
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.title}>Post Bulk E-Waste</Text>
                        <Text style={styles.subtitle}>Sell collected items in bulk</Text>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <TextInput
                            ...
                            placeholder="Describe the bulk items, condition details, etc..."
                    ...
                    >
                        {loading ? (
                            ...
                            <Text style={styles.submitButtonText}>Post Bulk E-Waste</Text>
                        )}
                    </TouchableOpacity>
                </View>
            </ScrollView>

...
export default function PostEWasteScreen({ navigation }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const result = await eWasteAPI.create(data);

            Alert.alert('Success', 'E-waste posted successfully!', [
                {
                    text: 'OK',
            ...
            console.error('Post e-waste error:', error);
            Alert.alert('Error', error.response?.data?.error || 'Failed to post e-waste');
        } finally {
            setLoading(false);
        }
    };
            ...
            <ScrollView style={styles.scrollView}>
                <View style={styles.content}>
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.title}>Post E-Waste</Text>
                        <Text style={styles.subtitle}>Help recycle your electronic waste</Text>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <TextInput
                            ...
                            placeholder="Describe the item, its age, and any issues..."
                    ...
                    >
                        {loading ? (
                            ...
                            <Text style={styles.submitButtonText}>Post E-Waste</Text>
                        )}
                    </TouchableOpacity>
                </View>
            </ScrollView>
